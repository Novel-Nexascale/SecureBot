  ...
  return (
    ...
    <div className="w-[450px] p-6 space-y-6 text-white ">
      <div className="space-y-2 text-left">
        <h1 className="text-2xl font-bold">Log In to SecureBot</h1>
      </div>
      ...
      <div className="space-y-4 ">
        ...
        <div className="pt-6">
          <Button className="w-full bg-yellow-600 text-white border-slate-800">Sign In</Button>
        </div>


        <div className='flex text-[14px] gap-1'>
          <p>Don`&#39`t have an account?</p> <Link href='#' className=" underline underline-offset-1 font-bold">Sign Up Now</Link>
        </div>
